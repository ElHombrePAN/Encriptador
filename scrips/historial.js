...
document.getElementById("guardar").addEventListener("click", () => {
 ...
 mostrarNotificacion("Debe ingresar un nombre valido ");
 return;
 }
...
function agregarSesion(sesion) {
 ...
 sesionDiv.innerHTML = `<h3>Fecha de creacion</h3><p class="sesion-id">${sesion.id}<br><br><h4>Nombre de la sesion<h4><p class="p-sesion">${sesion.nombre}</p>`; //usando template strings
